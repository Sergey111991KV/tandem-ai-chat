...
- [x] Tag `desktop-v0.1.3` — artifacts on GitHub Releases + `Website/downloads/` (`windowsDownloadReady` / `linuxDownloadReady`)
- [ ] Optional: Authenticode signing for Windows
- [x] Ship Telegram `apiId`/`apiHash` in release config (same as iOS `Config/Release.xcconfig`)
